#https://github.com/AI4LIFE-GROUP/OpenXAI/blob/155f599ceb7f29c5e4f839df0750eb0d3a5229d7/openxai/dgp_synthetic.py#L49
import numpy as np
import pandas as pd
...
class generate_gaussians:
    ...
    def dgp_vars(self,data_name="all"):
        ...
        # Loop over all clusters (mask and effective weights are the same in the same clusters)
        ...
        if data_name == 'train':
            ...
            data_dict = var_dict_test
        elif data_name=="all":
            data_dict=var_dict_train

        dataset = pd.DataFrame(data_dict['data'])
        ...
        masked_weights = data_dict['masked_weights']
        cluster_idx = data_dict['cluster_idx']



        return dataset,probs,masks,weights,masked_weights,cluster_idx


#https://github.com/AI4LIFE-GROUP/OpenXAI/blob/155f599ceb7f29c5e4f839df0750eb0d3a5229d7/openxai/dataloader.py#L17
