...
if __name__ == "__main__":
    ...
    #for model_name in ['Tarnet', 'Tarnet_tr', 'Drnet', 'Drnet_tr', 'Vcnet', 'Vcnet_tr']:
        ...
        for _ in range(num_dataset):
            ...
            # to load
            checkpoint = torch.load('logs/ihdp/eval/' + str(_) + '/Vcnet_disentangled_ckpt.pth.tar')
            model_trained.load_state_dict(checkpoint['model_state_dict'])


            checkpoint = torch.load('logs/ihdp/eval/' + str(_) + '/Vcnet_disentangledno_beta_ckpt.pth.tar')
            ...
            fig.savefig(cur_save_path +"initial_disentangled_no_beta_fig_ihdp_"+ str(_) + ".png")
            ...
            fig_trained.savefig(cur_save_path +"trained_disebtangled_trained_fig_ihdp_"+ str(_) + ".png")
            # #
